...
#define CS_LOW 		HAL_GPIO_WritePin(GPIOA, GPIO_PIN_4, CS_DISABLE)
#define CS_HIGH     HAL_GPIO_WritePin(GPIOA, GPIO_PIN_4, CS_ENABLE)
#define RESET_LOW   HAL_GPIO_WritePin(GPIOA, GPIO_PIN_8, RESET_DISABLE)
#define RESET_HIGH  HAL_GPIO_WritePin(GPIOA, GPIO_PIN_8, RESET_ENABLE)
