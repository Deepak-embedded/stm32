...
#define CS_LOW 		HAL_GPIO_WritePin(ADC_CS_GPIO_Port, ADC_CS_Pin, CS_DISABLE)
#define CS_HIGH     HAL_GPIO_WritePin(ADC_CS_GPIO_Port, ADC_CS_Pin, CS_ENABLE)
...
#define DRDY_PIN    ADC_DRDY_Pin
#define DRDY_PORT   ADC_DRDY_GPIO_Port
