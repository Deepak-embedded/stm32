...
#define MCP23_RST1_PORT		MCP23_RST1_GPIO_Port
#define MCP23_RST1_PIN 		MCP23_RST1_Pin

#define MCP23_CS_PIN		MCP23_CS_Pin
#define MCP23_CS_PORT 		MCP23_CS_GPIO_Port
